...
export default function PontosMap({ pontos }) {
  ...
  if (withCoords.length === 0) {
    return (
      <div className="flex h-96 items-center justify-center rounded-card border-2 border-slate-300 bg-white text-sm text-slate-400 shadow-card dark:border-navy-600 dark:bg-navy-800 dark:text-slate-500">
