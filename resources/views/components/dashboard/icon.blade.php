...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" {{ $attributes->merge(['class' => 'h-5 w-5']) }}>
    @switch($name)
        ...
        @case('building')
            ...
            @break
        @case('sliders')
            <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m9 6h3.75M3.75 12H15m0 0a1.5 1.5 0 103 0m-3 0a1.5 1.5 0 013 0M3.75 18H7.5m9 0h3.75M7.5 18a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0" />
            @break
        @case('arrow-up-right')
        ...
        @case('refresh')
            ...
            @break
        @case('plug')
            <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 119 0v3.75M3.75 18h15A2.25 2.25 0 0021 15.75v-1.5a2.25 2.25 0 00-2.25-2.25h-15A2.25 2.25 0 001.5 14.25v1.5A2.25 2.25 0 003.75 18zm6-9v9m-3-9v9" />
            @break
        @default
